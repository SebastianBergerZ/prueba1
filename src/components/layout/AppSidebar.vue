<template>
  <aside
    class="flex flex-col min-h-screen bg-qanty-sidebar text-white flex-shrink-0 overflow-hidden transition-all duration-300 ease-in-out"
  ...
  >
    ...
    <nav class="px-2 py-3 space-y-0.5 flex-shrink-0">
      <RouterLink
        ...
        :key="item.to"
        :to="item.to"
        class="flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors text-white/70 hover:bg-qanty-sidebar-hover hover:text-white"
        active-class="!bg-qanty-sidebar-active !text-white"
        :title="item.label"
      >
    ...
    <div class="flex-1 overflow-y-auto px-2 space-y-0.5">
      ...
      <button
        ...
        class="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-white/50 hover:bg-qanty-sidebar-hover hover:text-white transition-colors w-full text-left"
      >
